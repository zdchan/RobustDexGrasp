...
class Dagger:
    ...
    def act(self, total_obs, student_driven_ratio):
        ...
        student_mlp_obs = np.concatenate([total_obs[:, hlen: hlen + self.tobeEncode_dim], student_latent, total_obs[:, hlen + self.tobeEncode_dim + self.prop_latent_dim:]], 1)
    ...
    def step(self, total_obs, rews, dones):
